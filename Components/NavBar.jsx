...
const NavBar = () => {
  ...
  return (
    <div className="backgroundMain">
        ...
        <div className="relative flex items-center justify-between">
          <div className="flex items-center">
            <a href="/" aria-label="Company" title="Company" className="inline-flex items-center mr-8">
              ...
              <span className="ml-2 text-xl font-bold tracking-wide text-gray-100 uppercase">kROWD</span>
            </a>
      ...
      className="
        relative inline-flex items-center justify-center px-6 h-12
        font-medium text-white bg-transparent rounded-md
        border border-white overflow-hidden
        before:absolute before:top-0 before:left-[-100%] before:w-[100%] before:h-[100%]
        before:border-t before:border-b before:border-blue-500
                ...
                <div className="p-5 bg-white border rounded shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div>
                      ...
                      >
                        <svg className="w-5 text-gray-600" viewBox="0 0 24 24" fill="currentColor">
                          <path d="M19.7 4.3a1 1 0 0 0-1.4 0L12 10.6 5.7 4.3a1 1 0 0 0-1.4 1.4l6.3 6.3-6.3 6.3a1 1 0 1 0 1.4 1.4L12 13.4l6.3 6.3a1 1 0 0 0 1.4-1.4L13.4 12l6.3-6.3a1 1 0 0 0 0-1.4z" />
                        </svg>
                      </button>
                    </div>
                  </div>
